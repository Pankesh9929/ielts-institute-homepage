      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">IELTSPro</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              Your premier destination for IELTS preparation with proven results, 
              expert instructors, and innovative learning technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#features" className="text-gray-400 hover:text-white transition duration-300">Courses</a></li>
