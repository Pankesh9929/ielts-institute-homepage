        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-blue-600 font-bold text-2xl">IELTSPro</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#features" className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium">Courses</a>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
            ...
            <a href="#features" className="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">Courses</a>
            ...
            <button className="bg-blue-600 text-white w-full mt-2 px-4 py-2 rounded-md text-base font-medium hover:bg-blue-700 transition duration-300">
              Free Trial
            </button>
          </div>
        </div>
